----------------------------------------------------------------------------------------- 
------- FAST INPUT FILE ----------------------------------------------------------------- 
20 MW common research wind turbine model FAST input data, developed by Dr. Turaj Ashuri.  
Compatible with FAST V6.
---------------------- SIMULATION CONTROL ----------------------------------------------- 
...
172374.206     VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1] 
0.11     VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1] 
...
1.4476      BlPitch(1)  - Blade 1 initial pitch (degrees) 
1.4476      BlPitch(2)  - Blade 2 initial pitch (degrees) 
1.4476      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades] 
1.4476      B1PitchF(1) - Blade 1 final pitch for pitch maneuvers (degrees) 
1.4476      B1PitchF(2) - Blade 2 final pitch for pitch maneuvers (degrees) 
1.4476      B1PitchF(3) - Blade 3 final pitch for pitch maneuvers (degrees) [unused for 2 blades] 
...
7.15      RotSpeed    - Initial or fixed rotor speed (rpm) 
0.0      NacYaw      - Initial or fixed nacelle-yaw angle (degrees) 
0.0      TTDspFA     - Initial fore-aft tower-top displacement (meters) 
0.0      TTDspSS     - Initial side-to-side tower-top displacement (meters) 
---------------------- TURBINE CONFIGURATION ----------------------------------- 
138      TipRad      - The distance from the rotor apex to the blade tip (meters) 
...
-8  OverHang    - Distance from yaw axis to rotor apex [3 blades] or teeter pin [2 blades] (meters) 
3.4      NacCMxn     - Downwind distance from the tower-top to the nacelle CM (meters) 
0.0      NacCMyn     - Lateral  distance from the tower-top to the nacelle CM (meters) 
3     NacCMzn     - Vertical distance from the tower-top to the nacelle CM (meters) 
155     TowerHt     - Height of tower above ground level [onshore] or MSL [offshore] (meters) 
4.5     Twr2Shft    - Vertical distance from the tower-top to the rotor shaft (meters) 
...
944965.9054   NacMass     - Nacelle mass (kg) 
252808.7385   252808.7385     - Hub mass (kg) 
...
76840106.2073   NacYIner    - Nacelle inertia about yaw axis (kg m^2) 
7248.3239    GenIner     - Generator inertia about HSS (kg m^2) 
2064983.2366  HubIner     - Hub inertia about rotor axis [3 blades] or teeter axis [2 blades] (kg m^2) 
---------------------- DRIVETRAIN ---------------------------------------------- 
100      GBoxEff     - Gearbox efficiency (%) 
94.4      GenEff      - Generator efficiency [ignored by the Thevenin and user-defined generator models] (%) 
164      GBRatio     - Gearbox ratio (-) 
...
6941096000  DTTorSpr    - Drivetrain torsional spring (N-m/rad) 
49720000  DTTorDmp    - Drivetrain torsional damper (N-m/(rad/s)) 
...
"Tower_Onshore.dat"          TwrFile     - Name of file containing tower properties (quoted string) 
---------------------- NACELLE-YAW --------------------------------------------- 
...
---------------------- AERODYN ------------------------------------------------- 
"Aero_7u.inp"                ADFile      - Name of file containing AeroDyn input parameters (quoted string) 
---------------------- NOISE --------------------------------------------------- 
NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True] 
---------------------- ADAMS --------------------------------------------------- 
"ADAMS.dat"          ADAMSFile   - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1] 
---------------------- LINEARIZATION CONTROL ----------------------------------- 
"Linear.dat"                 LinFile     - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1] 
---------------------- OUTPUT -------------------------------------------------- 
...
2        DecFact     - Decimation factor for tabular output {1: output every time step} (-) 
30.0      SttsTime    - Amount of time between screen status messages (sec) 
...
5        NTwGages    - Number of tower nodes that have strain gages for output [0 to 9] (-) 
4,8,12,16,20  TwrGagNd    - List of tower nodes that have strain gages [1 to TwrNodes] (-) [unused if NTwGages=0] 
5        NBlGages    - Number of blade nodes that have strain gages for output [0 to 9] (-) 
3,7,10,12,14   BldGagNd     - List of blade nodes that have strain gages [1 to BldNodes] (-) [unused if NBlGages=0] 
OutList     - The next line(s) contains a list of output parameters.  See OutList.txt for a listing of available output channels, (-) 
"WindVxi  , WindVyi  , WindVzi , TotWindV"                    - Longitudinal, lateral, vertical and total wind speeds 
"GenPwr   , GenTq , GenSpeed"                                 - Electrical generator power, torque and speed 
"GenCq, GenCp"                                               - Generator torque and power  coefficients 
"RotSpeed , RotPwr"                                          - Low-speed shaft  speeds  and power 
"RotCq, RotCp, RotCt"                                      - Rotor power, torque, power and thrust coefficients 
"TipDxc1 , TipDyc1"                                          - Blade 1 out-of-plane and in-plane deflections  
"RootMyb1, RootMxb1"                                         - Blade 1 flapwise moment and Blade 1 edgewise moment at the root 
"Spn1MLyb1,Spn1MLxb1"                                        - Blade 1 local flapwise and edgewise moment at span station 1 
"Spn2MLyb1,Spn2MLxb1"                                        - Blade 1 local flapwise and edgewise moment at span station 2 
"Spn3MLyb1,Spn3MLxb1"                                        - Blade 1 local flapwise and edgewise moment at span station 3 
"Spn4MLyb1,Spn4MLxb1"                                        - Blade 1 local flapwise and edgewise moment at span station 4 
"Spn5MLyb1,Spn5MLxb1"                                        - Blade 1 local flapwise and edgewise moment at span station 4 
"BldPitch1"                                                  - Blade 1 pitch angle 
"Azimuth"                                                    - Blade 1 azimuth angle 
"TipSpdRat"                                                  - Tip speed ratio of the blade 
"LSSGagMya, LSSGagMza"                                       - Low-speed shaft 0- and 90-bending moments at the main bearing, it 1.912 m given by ShftGagL in above 
...
"TwHt1MLxt, TwHt1MLyt, TwHt1MLzt"                            - Tower local loads (side to side, fore-aft, torsional moments) at station 1 
"TwHt2MLxt, TwHt2MLyt, TwHt2MLzt"                            - Tower local loads (side to side, fore-aft, torsional moments) at station 2 
"TwHt3MLxt, TwHt3MLyt, TwHt3MLzt"                            - Tower local loads (side to side, fore-aft, torsional moments) at station 3 
"TwHt4MLxt, TwHt4MLyt, TwHt4MLzt"                            - Tower local loads (side to side, fore-aft, torsional moments) at station 4 
"TwHt5MLxt, TwHt5MLyt, TwHt5MLzt"                            - Tower local loads (side to side, fore-aft, torsional moments) at station 5 
